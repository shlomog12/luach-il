...
בפועל לא — בכל טעינת דף האפליקציה מנסה אוטומטית ובשקט (בלי פופאפ) לקבל טוקן
טרי, כל עוד אתם עדיין מחוברים לגוגל באותו דפדפן. כלומר גם אם נכנסתם פעם
בשבוע, האירועים ייטענו עדכניים לבד. רק אם אין חיבור פעיל לגוגל בדפדפן (או
שההרשאה בוטלה) יופיע כפתור "התחבר עם Google" לאישור ידני חד-פעמי.
